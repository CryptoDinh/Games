		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://www.akawang.xin";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://www.akawang.xin";
y.url = function() {
	return "http://www.akawang.xin?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://www.akawang.xin/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("A咖游戏—今日热门《搭汉堡》，等你来战！"),
	title: function() {
		return "我搭了一栋和【" + y.c.Gf() + "】一样高的摩天楼，敢不敢比一下？！"
	}
};
y.c = {
	font: "黑体",
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("A咖游戏", "Arial", 12);
	...
	Pi: function() {
		...
		dp_submitScore(a);
		b = _.sprintf("你搭了%d个汉堡，和【%s】一样高，分享到朋友圈和小伙伴比比吧！", a, y.c.Gf());
		A.Ia("end", "score", a);
		b = new y.c.oe(b, "再玩一次",
		function() {
			//this.fg(a)
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://www.akawang.xin"
			}, this);
