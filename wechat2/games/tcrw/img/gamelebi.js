...
GameLeBi = function(gameid, cpid) {
    ...
    this.fromid = null;
    this.fromuser = null;
    this.baseurl = "http://www.akawang.xin";
    this.gameurl = null;
    this.homeurl = null;
    this.gzurl = null;
    this.moreurl = null;
    ...
    this.shareData = {
        imgurl: "http://www.akawang.xin/img/icon.png",
        link: this.baseurl,
        title: "乐比游戏",
        content: "乐比游戏"
    };
...
GameLeBi.prototype.initGame = function() {
    ...
    this.shareData.imgurl = "http://www.akawang.xin/" + this.gameid + "/icon.png";
...
GameLeBi.prototype.connect = function() {
    if (localStorage.accessToken) {
        var url = "http://www.akawang.xin/connect2?gameid=" + this.gameid + "&access_token=" + localStorage.accessToken + (this.spid ? "&spid=" + this.spid: "") + (this.fromid ? "&uid=" + this.fromid: "");
        var _this = this;
        this.utils.ajax(url,
        function(data) {
            if (data.errcode) {
        ...
        var url = "http://www.akawang.xin/connect3.php?gameid=" + this.gameid + (this.spid ? "&spid=" + this.spid: "") + (this.utils.getParameter("f") == "zf" ? "&f=zf": "");
        var _this = this;
        this.utils.ajax(url,
        function(data) {
            _this.game = data.game;
...
GameLeBi.prototype.getGameInfo = function(gameid, callback) {
    this.utils.ajax("http://www.akawang.xin/gameinfo?gameid=" + gameid, callback)
};
...
GameLeBi.prototype.getEventToday = function(callback) {
    var url = "http://www.akawang.xin/getevent?gameid=" + this.gameid + (localStorage.myuid ? "&uid=" + localStorage.myuid: "");
    var _this = this;
    this.utils.ajax(url,
    function(data) {
...
GameLeBi.prototype.shareLog = function(options, callback) {
    var url = "http://www.akawang.xin/gameshare";
...
GameLeBi.prototype.submit = function(callback) {
    ...
    var url = "http://www.akawang.xin/submit?data=" + data;
    var _this = this;
    this.utils.ajax(url,
    function(data) {
        if (data.success) {
...
GameLeBiAuth.prototype.check = function(options) {
    ...
    if (options.level == "id" && !localStorage.accessToken) {
        ...
        var url = "http://www.akawang.xin/check";
...
GameLeBiAuth.prototype.getUser = function(callback) {
    if (!localStorage.token) {
        ...
        var _this = this;
        var url = "http://www.akawang.xin/getuser?token=" + localStorage.token;
        this.gamelebi.utils.ajax(url,
        function(data) {
            if (data.errcode) {
                localStorage.removeItem("token");
...
GameLeBiAuth.prototype.getFromUser = function() {
    ...
    if (id) {
        var _this = this;
        var url = "http://www.akawang.xin/getuser?id=" + id;
        this.gamelebi.utils.ajax(url,
        function(data) {
            var user = null;
            if (data.errcode) {
...
GameLeBiAuth.prototype.loginWx = function(redirect) {
    ...
    var url = "http://www.akawang.xin/check?fromurl=" + encodeURIComponent(trans);
    window.location = url
};
GameLeBiAuth.prototype.registerWx = function(redirect) {
    var trans = this.gamelebi.baseurl + "/auth/trans.app.html?origin=" + encodeURIComponent(redirect);
    var success = "http://www.akawang.xin/check?fromurl=" + encodeURIComponent(trans);
    var fail = this.gamelebi.baseurl + "/app/games.html";
    var url = "http://www.akawang.xin/getuser?success=" + encodeURIComponent(success) + "&fail=" + encodeURIComponent(fail);
    window.location = url
};
...
GameLeBiAuth.prototype.saveLink = function(callback) {
    ...
    if (id && localStorage.accessToken && id != localStorage.myuid) {
        var url = "http://www.akawang.xin/link?access_token=" + localStorage.accessToken + "&id=" + id;
        var _this = this;
        this.gamelebi.utils.ajax(url,
        function(data) {
            var result = 0;
...
GameLeBiUtils.prototype.getHead64 = function(headimgurl) {
    if (!headimgurl) return "http://www.akawang.xin/default.png";
                ...
                function() {
                    if (isZhousouInstalled) {
                        if (_this.getAppType() == "wx") {
                            ...
                            tip.src = "http://www.akawang.xin/img/" + (_this.isIOS() ? "zhongsou_share_ios.png": "zhongsou_share_android.png");
...
GameLeBiWx.prototype.initJsApi = function() {
    ...
    var ajaxUrl = "http://www.akawang.xin/getjsapisignature/?noncestr=" + noncestr + "&timestamp=" + timestamp + "&url=" + encodeURIComponent(url);
    var _this = this;
...
GameLeBiUC.prototype.createIconImage = function() {
    ...
    if (!img) {
        ...
        if (this.gamelebi.gameid) img.src = "http://www.akawang.xin/" + this.gamelebi.gameid + "/icon.png";
        else img.src = "http://www.akawang.xin/img/icon.png";
