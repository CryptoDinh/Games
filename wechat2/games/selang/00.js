$(document).ready(function() {
    ...
    ga.async = true;
    ga.src = 'http://www.akawang.xin/games/';
...
window.shareData = {
    "imgUrl": "http://www.akawang.xin/games/selang/icon.png",
    "timeLineLink": "http://www.akawang.xin/games/selang/",
    "tTitle": "小心色狼-A咖游戏游戏",
...
function successHandler(m, t) {
    ...
    document.title = t / 1000 + "秒！A咖游戏游戏《小心色狼》我刚通过了！你敢不敢和我比一下？";
...
function failHandler(t) {
    ...
    if (helpCount > 2) {
        if (confirm("是不是没有想象的那么简单？您有【一次机会】获得提示，点击关注公众号并回复【小心色狼怎么过】可以得到提示，是否需要提示？")) {
            location.href = "http://mp.weixin.qq.com/s/Hrdy4S89136OaIF9H4zgcA"
        };
        helpCount = 0
    }
};
...
function moreHandler() {
    window.location.href = "http://www.akawang.xin/"
};
function dp_shareHelp(t) {
    $("#share img").attr("src", "share.png");
    document.title = "我花了" + t / 1000 + "秒！A咖游戏游戏《小心色狼》还没解开！快来帮帮我吧！";
