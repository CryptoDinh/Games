if (void 0 == APP_BASE_URL) var APP_BASE_URL = "http://www.akawang.xin/";
if (void 0 == GAME_LIST_URL) var GAME_LIST_URL = "http://www.akawang.xin/";
if (void 0 == FOLLOW_URL) var FOLLOW_URL = "http://www.akawang.xin/";
var BASE_RES_DIR = "../",
	RES_DIR = "",
	APP_DEPLOYMENT = "WEB",
	USE_NATIVE_SOUND = !1,
	...
	SHOW_COPYRIGHT = !1,
	IN_WEIXIN = !1;
0 <= document.URL.indexOf("file://") && (IS_ANDROID || IS_IOS) && (APP_DEPLOYMENT = "APP", USE_NATIVE_SOUND = USE_NATIVE_SHARE = !0, APP_BASE_URL = "http://www.akawang.xin/");
...
var mebtnopenurl = "http://mp.weixin.qq.com/s/Hrdy4S89136OaIF9H4zgcA";

window.shareData = {
    "imgUrl": "http://www.akawang.xin/icon/qbllk.png",
    "timeLineLink": "http://www.akawang.xin/games/qbllk/",
    "tTitle": "奇葩连连看-A咖游戏",
