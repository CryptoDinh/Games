...
~function(bt) {
    bt.URL = {
        root: "http://www.akawang.xin",
        getMoreGame: function() {
            bt.dc("more");
            return "http://www.akawang.xin"
        },
        getConcern: function() {
            return "http://mp.weixin.qq.com/s/Hrdy4S89136OaIF9H4zgcA"
        },
        appId: ""
    };
...
// ~function(bt) {
//     function ask(b) {
//         if (confirm('关注"2144游戏"微信，就可以收藏这个游戏哦！')) {
...
~function(bt) {
    ...
    onlyH.prototype = {
        ...
        getScreenOption: function() {
            return {
                id: "bt-h-scrren",
                html: "<table><tr><td><img class='bt-h-screen-img'  src='http://m.2144.cn/act/wxhtml5/zhaonimei/100405_7462.jpg' /></td></tr></table>",
                time: 0x0,
                lockId: "bt-hide-lock"
            }
        },
    ...
    onlyH.prototype, {
        ...
        getScreenOption: function() {
            return {
                id: "bt-v-scrren",
                html: "<table><tr><td><img class='bt-v-screen-img' src='http://game.html5youxi.com/201501/zhaonimei/100433_5472.png' /></td></tr></table>",
                time: 0x0,
                lockId: "bt-hide-lock"
            }
        }
...
~function(bt) {
    ...
    function tip() {
        var c = bt.advertisement({
            id: b,
            html: "<img class='bt-play-share-tip-img' src='http://game.html5youxi.com/201501/zhaonimei/100500_5390.png' />",
            time: 0x0
        });
        c.show();
        setTimeout(function() {
