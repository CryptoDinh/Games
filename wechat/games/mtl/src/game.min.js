		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://demo9.52jscn.com";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://demo9.52jscn.com";
y.url = function() {
	return "http://demo9.52jscn.com?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://demo9.52jscn.com/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("锦尚中国—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("锦尚中国", "Arial", 12);
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://demo9.52jscn.com"
			}, this);
